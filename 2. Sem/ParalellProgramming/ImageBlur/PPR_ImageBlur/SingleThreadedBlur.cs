...
public static class SingleThreadedBlur
{
    public static Bitmap ApplyGaussianBlur(Bitmap image, int blurRadius)
    {
        // Create a Gaussian blur filter kernel
    ...
    private static unsafe Bitmap ConvolutionFilter(Bitmap inImage, float[,] kernel)
    {
